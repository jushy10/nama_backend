...
from app.endpoints.annual_earnings_endpoints import (
    router as annual_earnings_router,
)
from app.endpoints.cron.annual_earnings_endpoints import (
...
from app.endpoints.cron.recommendations_endpoints import (
    router as recommendations_cron_router,
)
from app.endpoints.cron.news_endpoints import router as news_cron_router
from app.endpoints.cron.fundamentals_endpoints import (
...
from app.endpoints.analyst_endpoints import router as analyst_router
from app.endpoints.news_endpoints import router as news_router
from app.endpoints.cron.universe_endpoints import (
...
from app.endpoints.cron.etf_endpoints import router as etf_cron_router
from app.endpoints.etf_endpoints import router as etf_router
from app.endpoints.revenue_segments_endpoints import (
...
from app.endpoints.insider_transactions_endpoints import (
...
from app.endpoints.institutional_ownership_endpoints import (
...
from app.endpoints.congress_endpoints import router as congress_router
from app.endpoints.cron.congress_endpoints import (
    router as congress_cron_router,
)
from app.endpoints.ticker_endpoints import router as ticker_router
from app.endpoints.options_endpoints import router as options_router
from app.endpoints.heatmap_endpoints import router as heatmap_router
from app.endpoints.analysis_endpoints import router as analysis_router
from app.endpoints.chart_endpoints import router as chart_router
from app.endpoints.logo_endpoints import router as logo_router
from app.endpoints.market_endpoints import router as market_router
from app.endpoints.yields_endpoints import router as yields_router
from app.endpoints.sentiment_endpoints import router as sentiment_router
from app.endpoints.market_brief_endpoints import router as market_brief_router
from app.endpoints.cron.market_brief_endpoints import (
    router as market_brief_cron_router,
)
from app.endpoints.earnings_calendar_endpoints import (
...
# app/endpoints/yields_endpoints.py.
...
# app/endpoints/quarterly_earnings_endpoints.py.
...
# yfinance. See app/endpoints/annual_earnings_endpoints.py.
...
# app/endpoints/analyst_endpoints.py.
...
# app/endpoints/news_endpoints.py.
...
# app/endpoints/revenue_segments_endpoints.py.
...
# app/endpoints/insider_transactions_endpoints.py.
...
# app/endpoints/institutional_ownership_endpoints.py.
...
# app/endpoints/cron/quarterly_earnings_endpoints.py.
...
# app/endpoints/cron/annual_earnings_endpoints.py.
app.include_router(annual_earnings_cron_router)
# The ticker endpoints (app/endpoints/ticker_endpoints.py): the card
...
# ticker card's options_metrics block. See app/endpoints/options_endpoints.py.
...
# app/endpoints/cron/recommendations_endpoints.py.
...
# headlines. See app/endpoints/cron/news_endpoints.py.
...
# inputs. See app/endpoints/cron/fundamentals_endpoints.py.
...
# app/endpoints/cron/performance_endpoints.py.
...
# app/endpoints/cron/institutional_ownership_endpoints.py.
...
# app/endpoints/congress_endpoints.py.
...
# stock's revenue disaggregation. See app/endpoints/cron/revenue_segments_endpoints.py.
...
# See app/endpoints/cron/insider_transactions_endpoints.py.
...
# app/endpoints/cron/congress_endpoints.py.
...
# endpoint over it is deferred. See app/endpoints/cron/universe_endpoints.py.
...
# app/endpoints/cron/index_membership_endpoints.py.
...
# filter menu), served from the slice's own `etfs` table. See app/endpoints/etf_endpoints.py.
...
# app/endpoints/cron/etf_endpoints.py.
...
# app/endpoints/heatmap_endpoints.py.
...
# market-brief cron. See app/endpoints/market_brief_endpoints.py.
...
# the other crons. See app/endpoints/cron/market_brief_endpoints.py.
...
# app/endpoints/earnings_calendar_endpoints.py.
...
# app/endpoints/seo_endpoints.py and app/domains/seo/README.md.
app.include_router(seo_router)
# The AI research agent (POST /agents/research): a plain-English stock-research question answered by a
