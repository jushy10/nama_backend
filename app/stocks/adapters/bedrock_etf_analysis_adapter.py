    ...
    "input_schema": {
        ...
        "properties": {
            ...
            "strengths": {
                ...
                "items": {"type": "string"},
                "description": (
                    "Up to 3 short, plain-language reasons the fund looks good — each clear on its "
                    "own to someone with no finance background."
                ),
            },
            "risks": {
                "type": "array",
                "items": {"type": "string"},
                "description": (
                    "Up to 3 short, plain-language reasons to be cautious — each clear on its own "
                    "to someone with no finance background."
                ),
            },
        },
...
_SYSTEM_PROMPT = (
    ...
    "and lower your confidence. Be honest about both the good and the bad. This is general "
    ...
    def analyze(self, detail: EtfDetail) -> InvestmentAnalysis:
        ...
        try:
            ...
            raise StockDataUnavailable(
                detail.ticker, f"analysis model call failed: {exc}"
            ) from exc
