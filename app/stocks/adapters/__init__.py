...
``_adapter.py``. Currently home to the analyst-estimates adapters (FMP, the DB-cache
decorator, and the in-memory TTL cache); other features' adapters still live beside
their code and can migrate here over time.
"""
