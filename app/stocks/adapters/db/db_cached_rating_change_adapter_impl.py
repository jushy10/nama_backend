...
from app.stocks.company.recommendations.interfaces import RatingChangeAdapter
from app.stocks.company.recommendations.interfaces import RatingChangesRepositoryAdapter
