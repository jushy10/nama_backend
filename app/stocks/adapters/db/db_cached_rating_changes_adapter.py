...
from app.stocks.company.recommendations.ports import RatingChangeProvider
from app.stocks.company.recommendations.repository import RatingChangesRepository
