...
from app.domains.ownership.congress.models import StockCongressTradeRecord
from app.domains.ownership.congress.interfaces import CongressTradesRepositoryAdapter, RefreshTarget
...
class CongressTradesRepositoryAdapterImpl(CongressTradesRepositoryAdapter):
