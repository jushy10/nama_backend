...
from app.domains.ownership.congress.interfaces import CongressTradesAdapter
from app.domains.ownership.congress.interfaces import CongressTradesRepositoryAdapter
