...
from app.domains.ownership.institutional_ownership import models
...
from app.domains.ownership.institutional_ownership.models import (
    StockInstitutionalHolderRecord,
    StockOwnershipSummaryRecord,
)
from app.domains.ownership.institutional_ownership.interfaces import (
...
class InstitutionalOwnershipRepositoryAdapterImpl(InstitutionalOwnershipRepositoryAdapter):
