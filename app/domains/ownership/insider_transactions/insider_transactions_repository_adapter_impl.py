...
from app.domains.ownership.insider_transactions import models
from app.domains.ownership.insider_transactions.entities import (
    InsiderActivity,
    InsiderTransaction,
)
from app.domains.ownership.insider_transactions.models import StockInsiderTransactionRecord
...
class InsiderTransactionsRepositoryAdapterImpl(InsiderTransactionsRepositoryAdapter):
