...
_SYSTEM_PROMPT = (
    ...
    "assistant's ANSWER. JudgeAdapter the answer ONLY against the rubric.\n"
    "Guidance:\n"
    ...
    "- JudgeAdapter substance, not style or length. A correct, on-rubric answer passes even if terse.\n"
...
class JudgeAdapterImpl(JudgeAdapter):
