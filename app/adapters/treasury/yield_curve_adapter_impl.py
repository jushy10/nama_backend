...
from app.domains.macro.yields.entities import YieldCurve, YieldTenor
from app.domains.macro.yields.interfaces import YieldCurveAdapter
...
class YieldCurveAdapterImpl(YieldCurveAdapter):
