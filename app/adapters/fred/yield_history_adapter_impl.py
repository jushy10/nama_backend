...
from app.domains.macro.yields.entities import YieldHistory, YieldObservation, YieldSeries
from app.domains.macro.yields.interfaces import YieldHistoryAdapter
...
class YieldHistoryAdapterImpl(YieldHistoryAdapter):
