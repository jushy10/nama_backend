...
from app.domains.etfs.entities import EtfScreenIntent, EtfSort, SortDirection
from app.domains.etfs.interfaces import EtfScreenerQueryAdapter
...
class EtfScreenerQueryAdapterImpl(EtfScreenerQueryAdapter):
