...
from app.domains.seo.seo_read_repository_adapter_impl import SeoReadRepositoryAdapterImpl
from app.domains.seo.interfaces import CongressPageTrade, EtfPageFacts, TickerPageFacts
...
_TEMPLATES = Jinja2Templates(
    directory=str(Path(__file__).resolve().parent.parent / "domains" / "seo" / "templates")
)
