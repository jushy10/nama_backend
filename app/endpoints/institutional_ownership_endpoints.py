...
from app.domains.ownership.institutional_ownership.interfaces import InstitutionalOwnershipAdapter
from app.domains.ownership.institutional_ownership.schemas import (
    HolderFlowResponse,
    InstitutionalHolderResponse,
    InstitutionalOwnershipResponse,
    OwnershipBreakdownResponse,
)
from app.domains.ownership.institutional_ownership.use_cases import GetInstitutionalOwnership
