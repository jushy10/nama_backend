...
from app.adapters.alpaca.price_adapter_impl import PriceAdapterImpl as AlpacaPriceAdapterImpl
...
from app.domains.shared.interfaces import AnalystEstimatesAdapter, GenerationQuotaAdapter
