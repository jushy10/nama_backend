...
└── stocks/                 # the stocks vertical slice
    ...
    │   ├── cron_universe_endpoints.py            #  POST /internal/universe/sync (synchronous)
