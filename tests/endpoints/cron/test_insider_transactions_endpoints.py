...
from app.endpoints.cron import insider_transactions_endpoints as cron
from app.domains.ownership.insider_transactions.use_cases import InsiderTransactionsSyncReport
