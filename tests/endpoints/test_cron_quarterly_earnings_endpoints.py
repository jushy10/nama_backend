...
checks only the controller — that it invokes the use case with the requested limit, presents
the summary, and validates the limit — without touching Yahoo or the database.
"""
