"""Tests for the institutional-ownership cron endpoint.

(POST /internal/institutional-ownership/sync)
...
from app.stocks.endpoints import cron_institutional_ownership_endpoints as cron
...
def _drain() -> None:
    """Block until the background sweep has finished (re-acquiring the held lock means it's done)."""
