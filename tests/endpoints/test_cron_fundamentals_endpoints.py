"""Tests for the fundamentals cron endpoint (POST /internal/fundamentals/sync).
...
limit, guards against overlapping runs, and validates the limit — without touching Yahoo or the
database.
