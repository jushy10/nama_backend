"""Tests for the revenue-segments cron endpoint (POST /internal/revenue-segments/sync).
...
limit, guards against overlapping runs, and validates the limit — without touching SEC or the
database.
