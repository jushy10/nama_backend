...
def test_dedupes_tickers_across_page_seams():
    ...
    out = YfinanceEtfScreenerProvider(screen_page=pages).screen(min_net_assets=_FLOOR)
...
def test_live_page_retries_a_blocked_screen_then_succeeds(monkeypatch):
    ...
    from app.stocks.adapters.yfinance.etf_screener_adapter import _live_screen_page
