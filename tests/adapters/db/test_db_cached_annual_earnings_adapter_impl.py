...
class FakeInner(AnnualEarningsAdapter):
...
def _decorator(inner: FakeInner, repo: FakeRepo) -> AnnualEarningsAdapterImpl:
    return AnnualEarningsAdapterImpl(inner, repo)
