...
class FakeInner(QuarterlyEarningsAdapter):
...
def _decorator(inner: FakeInner, repo: FakeRepo) -> QuarterlyEarningsAdapterImpl:
    return QuarterlyEarningsAdapterImpl(inner, repo)
