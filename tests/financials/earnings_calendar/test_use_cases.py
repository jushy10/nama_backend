...
def test_clamps_an_over_wide_window():
    repo = _FakeRepository()
    _uc(repo).run(_TODAY, _TODAY + timedelta(days=365))
    _, end, _ = repo.window
